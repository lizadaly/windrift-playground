...
import cards from 'public/stories/visual-story/styles/Cards.module.scss'
                ...
                <animated.div
                    ...
                    {item.c && (
                        <C
                            ...
                            widget={ImageChoice}
                            extra={{
                                src: `/stories/visual-story/images/${item.c.fn || item.c.tag}.webp`,
                                alt: item.c.alt,
